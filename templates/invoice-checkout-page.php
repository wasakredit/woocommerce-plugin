  ...
  $quantity        = $cart_item['quantity'];
	...
	$wasa_cart_items[] = array(
        ...
        'total_price_ex_vat' => array(
            'amount' => $price_ex_vat * $quantity,
            'currency' => $currency
        ),
        'total_price_incl_vat' => array(
            'amount' => $price_inc_vat * $quantity,
            'currency' => $currency
        ),
        'total_vat' => array(
            'amount' => $price_vat * $quantity,
            'currency' => $currency
        )
	);
}
...
$payload = array(
    ...
    'total_price_ex_vat'      =>
        array(
            'amount'    => $order_data["total"] - $order_data["total_tax"],
            'currency'  => $currency),
    'total_vat'                 =>
        array(
            'amount'    => $order_data["total_tax"],
            'currency'  => $currency)
);
